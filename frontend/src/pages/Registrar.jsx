  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 via-teal-400 to-cyan-500" />
        <div className="absolute -top-40 -left-40 h-80 w-80 animate-pulse rounded-full bg-gradient-to-r from-green-400/30 to-emerald-500/30 blur-3xl" />
        <div
          className="absolute -bottom-40 -right-40 h-96 w-96 animate-pulse rounded-full bg-gradient-to-r from-teal-400/20 to-cyan-500/20 blur-3xl"
          style={{ animationDelay: '2s' }}
        />
        <div
          className="absolute left-1/3 top-1/4 h-64 w-64 animate-pulse rounded-full bg-gradient-to-r from-emerald-400/10 to-green-400/10 blur-2xl"
      ...
      >
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white mb-2 drop-shadow-sm">Junte-se a nós!</h1>
          <p className="text-white/80 font-medium">Crie sua conta e comece sua jornada financeira</p>
        </motion.div>
        ...
        {ok && (
          <motion.div 
            ...
            className="mb-6 text-sm text-emerald-100 bg-emerald-500/30 backdrop-blur-sm border border-emerald-400/50 rounded-2xl p-4 flex items-center gap-2"
          >
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                value={form.nome} 
                onChange={onChange}
                className="w-full pl-11 pr-4 py-3 rounded-2xl border border-white/30 bg-white/10 backdrop-blur-sm text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300 shadow-sm"
